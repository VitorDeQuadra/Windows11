...
spegniBtn.addEventListener("click", function () {
    ...
    alert("Agora, o Windows 11 (Web Edition) será praticamente desligado, Para retornar à página inicial, clique em qualquer lugar na tela!");
});
...
function DispositivoNonSupportato() {
    ...
    function checkSopporto() {
        ...
        if (window.innerWidth < 800) {
            widthSpiegazione.innerHTML = "ERRO DE LARGURA: você precisa de: <b>800px</b>" + "   " + "Para visualizar esta página";
            AttualeWidthContainer.innerHTML = window.innerWidth + "px";
            widthSpiegazione.style.color = "rgb(255, 0, 47)";
        } else {
            widthSpiegazione.innerHTML = "É a largura da sua tela!";
        ...
        if (window.innerHeight < 600) {
            heightSpiegazione.innerHTML = "ERRO DE ALTURA: você precisa de: <b>600px</b>" + "   " + "Para visualizar esta página";
            AttualeHeightContainer.innerHTML = window.innerHeight + "px";
            heightSpiegazione.style.color = "rgb(255, 0, 47)";
        } else {
            heightSpiegazione.innerHTML = "É a altura da sua tela!";
