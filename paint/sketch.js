...
const brushNames = ["Caneta", "Selo", "Caminho", "Borracha"];
...
function drawUI() {
  ...
  textFont("Poppins");
  textSize(16);
  text("Limpar tela", width - 70, height - 62);
  if (UITheme === "dark") {
    text("Modo claro", width - 70, height - 28);
  } else if (UITheme === "light") {
    text("Modo Escuro", width - 70, height - 28);
  }
  pop();
